...
<head>
    ...
    <title>Privacy Policy - Taartu</title>
    <meta name="description" content="Privacy Policy for Taartu booking marketplace">
        ...
        <div class="max-w-4xl mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <nav class="flex space-x-6">
                    <a href="{{ route('legal.terms') }}" class="text-gray-600 hover:text-gray-900">Terms</a>
                    <a href="{{ route('legal.privacy') }}" class="text-blue-600 font-medium">Privacy</a>
                </nav>
            </div>
        </div>
    </header>
